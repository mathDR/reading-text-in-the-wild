...
def build_model_train(previous_model=None):
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[0].get_weights()
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[2].get_weights()
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[4].get_weights()
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[5].get_weights()
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[8].get_weights()
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[10].get_weights()
        model.add(Dense(4096,activation='relu',weights=weights,init='glorot_uniform'))
    ...
    if previous_model is None:
        ...
        weights = previous_model.layers[12].get_weights()
        model.add(Dense(4096,activation='relu',weights=weights,init='glorot_uniform'))
    model.add(Dropout(0.5))
