...
if __name__ == '__main__':
    ...
    model_file = 'LOCATION OF charnet.mat from http://www.robots.ox.ac.uk/~vgg/research/text/#sec-models NIPS
                 DLW 2014 models'
    ...
    np.savez_compressed('matlab_charnet_weights',conv1W=conv1W,conv1b=conv1b,conv2W=conv2W,conv2b=conv2b,
